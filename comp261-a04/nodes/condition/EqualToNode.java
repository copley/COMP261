...
public class EqualToNode implements RobotCondNode {
	...
	public RobotCondNode parse(Scanner scan) {
		...
		// "gt"
		if (!Parser.gobble(Parser.EQUAL, scan)) {
			Parser.fail("FAIL: Expecting " + Parser.EQUAL.toString(), scan);
		}
		// "("
	...
	public String toString() {
		...
		return "eq(" + expNode1.toString() + ", " + expNode2.toString() + ")";
	}
}
