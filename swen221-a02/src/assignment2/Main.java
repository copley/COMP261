...
//		String fileName = null; // name of input file to read
		String fileName = "/Users/diego/Qsync/Victoria/GIT/swen221/swen221-a02/handout/maze1.dat"; 
		...
		// Pass the board to the LeftWalker after verifiying that is a LeftWalker
//		if (walker instanceof LeftWalker){
//			((LeftWalker) walker).passBoard(board);
//		}
		// solve the maze!
		walker.solve(board);
