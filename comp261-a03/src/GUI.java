...
/**
 * A simple GUI, similar to the one in assignments 1 and 2, that you can base your renderer off. It is abstract, and there are three methods you need
 * to implement: onLoad, onKeyPress, and render. You are free to use this class as-is, modify it, or ignore it completely.
 * 
...
public abstract class GUI {
	...
	/**
	 * Is called every time the user presses a key. This can be used for moving the camera around. It is passed a KeyEvent object, whose methods of
	 * interest are getKeyChar() and getKeyCode().
	 */
	protected abstract void onKeyPress(KeyEvent ev);
	
	/**
	 * Is called when the user scrolls the wheel
	 * @param e
	 */
	...
	/**
	 * Forces a redraw of the drawing canvas, you're unlikely to need to call this unless you modify this GUI.
	 */
	public void redraw() {
		frame.repaint();
	}
	...
	/**
	 * Returns the values of the three sliders used for setting the ambient light of the scene. The returned array in the form [R, G, B] where each
