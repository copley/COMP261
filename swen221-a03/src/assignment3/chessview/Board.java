...
public class Board {
	...
	boolean kingWhiteHasMoved;
	boolean kingBlackHasMoved;
	boolean rookWhiteLeftHasMoved;
	boolean rookWhiteRightHasMoved;
	boolean rookBlackLeftHasMoved;
	boolean rookBlackRightHasMoved;
	...
	public Board() {
		...
		kingWhiteHasMoved = false;
		kingBlackHasMoved = false;
		rookWhiteLeftHasMoved = false;
		rookWhiteRightHasMoved = false;
		rookBlackLeftHasMoved = false;
		rookBlackRightHasMoved = false;
	...
	public Board(Board board) {
		...
		// check if the kings have been moved
		if (board.getKingWhiteHasMoved()) {
			kingWhiteHasMoved = true;
		} else {
			kingWhiteHasMoved = false;
		}
		if (board.getKingBlackHasMoved()) {
			kingBlackHasMoved = true;
		} else {
			kingBlackHasMoved = false;
		}
		// check if the rooks have been moved
		if (board.getRookWhiteLeftHasMoved()) {
			rookWhiteLeftHasMoved = true;
		} else {
			rookWhiteLeftHasMoved = false;
		}
		if (board.getRookWhiteRightHasMoved()) {
			rookWhiteRightHasMoved = true;
		} else {
			rookWhiteRightHasMoved = false;
		}
		if (board.getRookBlackLeftHasMoved()) {
			rookBlackLeftHasMoved = true;
		} else {
			rookBlackLeftHasMoved = false;
		}
		if (board.getRookBlackRightHasMoved()) {
			rookBlackRightHasMoved = true;
		} else {
			rookBlackRightHasMoved = false;
		}
	}
	...
	// king white 
	public boolean getKingWhiteHasMoved() {
		return kingWhiteHasMoved;
	}
	
	public void setKingWhiteHasMoved(boolean kingHasMoved) {
		this.kingWhiteHasMoved = kingHasMoved;
	}
	
	// king black
	public boolean getKingBlackHasMoved() {
		return kingBlackHasMoved;
	}
		
	public void setKingBlackHasMoved(boolean kingHasMoved) {
		this.kingBlackHasMoved = kingHasMoved;
	}
	
	// rook white left
	public boolean getRookWhiteLeftHasMoved() {
		return rookWhiteLeftHasMoved;
	}
	
	public void setRookWhiteLeftHasMoved(boolean rookHasMoved) {
		this.rookWhiteLeftHasMoved = rookHasMoved;
	}
	
	// rook white right
	public boolean getRookWhiteRightHasMoved() {
		return rookWhiteRightHasMoved;
	}
	
	public void setRookWhiteRightHasMoved(boolean rookHasMoved) {
		this.rookWhiteRightHasMoved = rookHasMoved;
	}
	
	// rook black left
	public boolean getRookBlackLeftHasMoved() {
		return rookBlackLeftHasMoved;
	}
	
	public void setRookBlackLeftHasMoved(boolean rookHasMoved) {
		this.rookBlackLeftHasMoved = rookHasMoved;
	}
	
	// rook black right
	public boolean getRookBlackRightHasMoved() {
		return rookBlackRightHasMoved;
	}
	
	public void setRookBlackRightHasMoved(boolean rookHasMoved) {
		this.rookBlackRightHasMoved = rookHasMoved;
	}
